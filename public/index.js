...
(function (util,store){
    ...
    function Note(options){
        ...
        note.style.backgroundColor = '#'+Math.floor(Math.random()*0xffffff).toString(16);
        $('.u-timestamp',note).style.backgroundColor = '#'+Math.floor(Math.random()*0xffffff).toString(16);
    ...
    Note.prototype.addEvent = function(){
        ...
        editor.addEventListener('input', inputHandler);//input事件比较新，有的旧版浏览器可能不支持，可以用keydown，keyup事件
